...
var NAV_ITEMS = [
  { href: "/dashboard/transactions", label: "Lista de Transacciones", icon: /* @__PURE__ */ jsxRuntime.jsx(IconList, {}) },
  { href: "/dashboard/transactions/new", label: "Nueva Transacci\xF3n", icon: /* @__PURE__ */ jsxRuntime.jsx(IconPlus, {}) }
];
function Sidebar() {
